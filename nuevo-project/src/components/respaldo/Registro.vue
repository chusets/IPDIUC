        ...
        methods: {
          ...
          //MÉTODOS PARA EL CRUD
            ...
            erClick() {
                      ...
                      axios.post("http://localhost/PC/nuevo-project/backend/registro.php", 
                        {datos:JSON.stringify({Nivel_u:this.Nivel_User, Nomb_u:this.Nomb_User, Depar_u:this.Depar_User, Correo_u:this.Correo_User,
                         Pass_u:this.Pass_User,}) 
                        }
                      )
                      .then(response =>{           
                        //respuesta
